...
class CatatRawatSanitasi extends StatefulWidget {
  const CatatRawatSanitasi({Key? key}) : super(key: key);

  @override
  State<CatatRawatSanitasi> createState() => _CatatRawatSanitasiState();
}

class _CatatRawatSanitasiState extends State<CatatRawatSanitasi> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        labelText: "Total luas lahan yang disanitasi",
