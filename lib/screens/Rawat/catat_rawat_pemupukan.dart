...
class CatatRawatPemupukan extends StatefulWidget {
  const CatatRawatPemupukan({super.key}) ;

  @override
  State<CatatRawatPemupukan> createState() => _CatatRawatPemupukanState();
}

class _CatatRawatPemupukanState extends State<CatatRawatPemupukan> {
            ...
            child: Stack(
              children: [
                ...
                Container(
                  ...
                  child: Text('Perawatan Pemupukan',
                  style: GoogleFonts.poppins(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                    color: Colors.green
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        labelText: "Total Berat Pupuk (kg)",
                        border: OutlineInputBorder()
                    ),
                  ),
                ),
                ...
                Container(
                  padding: EdgeInsets.only(top: 515, left: 20, right: 20),
                ...
                Container(
                  padding: EdgeInsets.only(top: 580, left: 20, right: 20),
                  child: TextField(
                    keyboardType: TextInputType.number,
                    decoration: InputDecoration(
                        labelText: "Rp",
                ...
                Container(
                  padding: EdgeInsets.only(top: 651, left: 30, right: 205, bottom: 20),
                  width: 380,
                ...
                Container(
                  padding: EdgeInsets.only(top: 651, left: 205, right: 15, bottom: 20),
                  width: 380,
