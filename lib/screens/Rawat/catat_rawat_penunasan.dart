...
class CatatRawatPenunasan extends StatefulWidget {
  const CatatRawatPenunasan({super.key});
  @override
  State<CatatRawatPenunasan> createState() => _CatatRawatPenunasanState();
}

class _CatatRawatPenunasanState extends State<CatatRawatPenunasan> {
            ...
            child: Stack(
              children: [
                ...
                Container(
                  ...
                  child: Text('Perawatan Penunasan',
                  style: GoogleFonts.poppins(
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
                    color: Colors.green,
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        labelText: "Total Pohon yang ditunas",
