...
class CatatRawatPembabatan extends StatefulWidget {
  const CatatRawatPembabatan({Key? key}) : super(key: key);

  @override
  State<CatatRawatPembabatan> createState() => _CatatRawatPembabatanState();
}

class _CatatRawatPembabatanState extends State<CatatRawatPembabatan> {
            ...
            child: Stack(
              children: [
                ...
                Container(
                  ...
                  child: Text('Perawatan Pembabatan',
                    style: GoogleFonts.poppins(
                      fontWeight: FontWeight.bold,
                      fontSize: 20,
                      color: Colors.green,
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        labelText: "Total luas lahan yang dibabat",
