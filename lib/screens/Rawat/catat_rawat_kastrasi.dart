...
class CatatRawatKastrasi extends StatefulWidget {
  const CatatRawatKastrasi({Key? key}) : super(key: key);

  @override
  State<CatatRawatKastrasi> createState() => _CatatRawatKastrasiState();
}

class _CatatRawatKastrasiState extends State<CatatRawatKastrasi> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        labelText: "Total luas lahan yang dikastrasi",
